...
extension Color {
    public static var customBrown: Color {
    ...
    public static var customWhite: Color {
        return Color("CustomWhite")
    }
    public static var darkPink: Color {
        return Color("DarkPink")
    }
    public static var lightPink: Color {
        return Color("LightPink")
    }
    public static var customSecondaryColor: Color {
        return Color("CustomSecondaryColor")
    }
...
public var smallIPhones: [String] = [
...
func compressImage(imageName: String) -> Image {
    let image = UIImage(named: imageName)
    let resizedImage = image?.aspectFittedToHeight(250)
    resizedImage?.jpegData(compressionQuality: 0.3)
    return Image(uiImage: (resizedImage ?? UIImage(systemName: "xmark"))!)
}
